module counter (
    one_minute,new_current_time_ms_hr,new_current_time_ms_min,new_current_time_ls_hr,new_current_time_ls_min,
    load_new_c,clock,reset,current_time_ls_hr,current_time_ls_min,current_time_ms_hr,current_time_ms_min
);

input clock,reset,one_minute,load_new_c;
input [3:0] new_current_time_ls_hr,new_current_time_ls_min,new_current_time_ms_hr,new_current_time_ms_min;
output reg [3:0] current_time_ls_hr,current_time_ls_min,current_time_ms_hr,current_time_ms_min;
