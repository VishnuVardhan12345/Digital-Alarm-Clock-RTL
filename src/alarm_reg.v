module alarm_reg (
    new_alarm_time_ms_hr,new_alarm_time_ls_hr,new_alarm_time_ms_min,new_alarm_time_ls_min,load_new_a,clock,reset,
    alarm_time_ms_hr,alarm_time_ls_hr,alarm_time_ms_min,alarm_time_ls_min
);

input [3:0] new_alarm_time_ms_hr,new_alarm_time_ls_hr,new_alarm_time_ms_min,new_alarm_time_ls_min;
input load_new_a,clock,reset;
